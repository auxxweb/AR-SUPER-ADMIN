...
const DashBoardSection2 = () => {
  ...
  return (
    <>
      <div className="flex" style={{width:"100%", justifyContent:"center!important"}}>
        {/* Left Column (Large Section) */}
        <div style={{width:"100%"}} className="text-center w-100 bg-white shadow-lg border border-gray-300 gap-4 h-20  flex items-center justify-center rounded-lg">
          <svg
            width="52"
            height="52"
            viewBox="0 0 52 52"
