            ...
            <tr
              ...
              <td style={{minWidth:"10rem"}} className="flex px-4 py-2 border-r border-gray-400"><img
               ...
               className="w-10 h-10 rounded-full mr-1 mt-1"
                />{employee.name}</td>
              <td className="px-4 py-2 border-r border-gray-400">{employee.restaurantId}</td>
              <td className="px-4 py-2 border-r border-gray-400">{employee.address}</td>
              <td className="px-4 py-2 border-r border-gray-400">{employee.contactDetails}</td>
              <td className="px-4 py-2 border-r border-gray-400">{employee.category}</td>
              <td className="px-4 py-2 border-r border-gray-400">{employee.selectedPlan}</td>
              <td className="px-4 py-2 border-r border-gray-400">
